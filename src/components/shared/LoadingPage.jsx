'use client'; // Framer Motion এবং ক্লায়েন্ট সাইড অ্যানিমেশনের জন্য
    ...
    <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-[#F9E4CB]">
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-16 h-16">
          {/* Outer Ring */}
          <span className="absolute inset-0 border-2 border-black/10 rounded-full" />
